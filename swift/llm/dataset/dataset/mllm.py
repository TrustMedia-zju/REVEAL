...
register_dataset(
    DatasetMeta(
        dataset_path='/mnt/shangcephfs/mm-base-vision-ascend/sanmucao/datasets/benchmark/ft_local/swift1_think_data.json',
        subsets=[
            SubsetDataset(
                name='default',
                subset='default',
        ...
        tags=['qa', 'multi-modal', 'grpo']))
register_dataset(
    DatasetMeta(
        dataset_path='/mnt/shangcephfs/mm-base-vision-ascend/sanmucao/datasets/benchmark/ft_local/swift_1k_think_data.json',
        subsets=[
            SubsetDataset(
                name='default',
                subset='default',
...
register_dataset(
    DatasetMeta(
        dataset_path='/mnt/shangcephfs/mm-base-vision-ascend/sanmucao/datasets/benchmark/ft_local/updated_format_step1,2_think_data.json',
        subsets=[
            SubsetDataset(
                name='default',
                subset='default',
        ...
        # preprocess_func=ClevrPreprocessor(),
        tags=['qa', 'multi-modal', 'sft']))
register_dataset(
    DatasetMeta(
        dataset_path='/mnt/shangcephfs/mm-base-vision-ascend/sanmucao/datasets/benchmark/ft_local/updated_format_step1,2_think__mix_test_data.json',
        subsets=[
            SubsetDataset(
                name='default',
                subset='default',
